 ...
 */
package com.github.anasoid.hybris.javamelody.jalo;
...
/**
 * This is the extension manager of the Javamelody extension.
 */
public class JavamelodyManager extends GeneratedJavamelodyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(JavamelodyManager.class);
	 ...
	 */
	public static JavamelodyManager getInstance()
	{
		return (JavamelodyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(JavamelodyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JavamelodyManager() // NOPMD 
	{
		LOG.debug("constructor of JavamelodyManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of JavamelodyManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of JavamelodyManager called, current tenant: {}", getTenant().getTenantID());
	}
